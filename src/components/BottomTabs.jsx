...
export default function BottomTabs() {
  return (
    <div className="text-gray-400 z-20 bg-white fixed bottom-0 text-center w-full border-t pt-3 pb-3">
      <ul className="flex w-full text-3xl justify-between px-5 items-end">
        <li>
          <Link
            href={"/home"}
            className="items-center flex flex-col text-indigo-600"
          >
            <BiSolidHome />
        ...
        <li>
          <Link href={"/lists"} className="items-center flex flex-col">
